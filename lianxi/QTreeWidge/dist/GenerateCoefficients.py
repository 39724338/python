...
#生成磨耗厚度t与磨耗体积之间的2元2次方程的系数，为随机系数
class GenerateCoefficients:
    ...
    def equation(self, v):
        t = (self._a[0] * v ** 2 +self._a[1] * v + self._a[2])/(1e7)
        return t
    ...
    def plot(self):
        v_array = np.linspace(0, 9420, 1000)#生成0-9420之间的1000个数
        t_array = np.array([self.equation(v) for v in v_array])#生成t的值
